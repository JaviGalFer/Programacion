...
* de manera aleatoria
* Haciendo la suma de las filas y columnas, mostrando después el total con un retardo
* @author Fco Javier Gallego Fernández
*/

public class BidimensionCalculo3 {
  public static void main(String[] args) 
    ...
    for (fila = 0; fila < 4; fila++) {
      ...
      Thread.sleep(2000); // retardo de dos segundos
